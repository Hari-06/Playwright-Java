...
public final class DataProviderUtil {
  ...
  public static Object[] getData(Method m) {
    ...
    Predicate<Map<String, String>> isTestNameNotMatching =
      map -> !map.get("Test Method").equalsIgnoreCase(testMethod);
    Predicate<Map<String, String>> isExecuteColumnNo =
      map -> map.get("Execute").equalsIgnoreCase("no");
